...
public class Lines {
    ...
    public class View extends JComponent implements ChangeListener {
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2d.drawLine(550/2+20, 1060/2+50+(77/2), 775/2+20, 1060/2+50+(77/2));
            g2d.drawLine(550/2+20, 1060/2+50+(77/2), 550/2+20, 1060/2+50);
            g2d.drawLine(900/2+20, 1060/2+50+(10/2), 775/2+20, 1060/2+50+(10/2));
            g2d.drawLine(775/2+20, 1060/2+50+(77/2), 775/2+20, 1060/2+50+(10/2));
