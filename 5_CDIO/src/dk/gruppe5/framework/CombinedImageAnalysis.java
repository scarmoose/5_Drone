...
public class CombinedImageAnalysis {
	...
	public Mat findPositionFromQRandTriangles(Mat frame) {
		...
		Point mapPosition = test.getPositionFromPoints(adjustedLeftRealPos,Mathmagic.getPointFromName(nameOfQRMark), adjustRightRealPos, leftTrianglePixelCenter,centerCurrentContour, rightTrianglePixelCenter);
						if (mapPosition != null) {
