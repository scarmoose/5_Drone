...
//	public final static float[][] wallmarkDistances = new float[20][20]; 
	public final static Wallmark[] wallmarks = {
			...
			new Wallmark("W02.00",new Point(847, -10)), new Wallmark("W02.01",new Point(656, -77)), new Wallmark("W02.02",new Point(514, 0)), new Wallmark("W02.03",new Point(328, 0)), new Wallmark("W02.04",new Point(143,0)),
